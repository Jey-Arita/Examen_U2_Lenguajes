...
export const LoginPage = () => {
  ...
  return (
    ...
    <div
      ...
      style={{ backgroundImage: "url('https://img.freepik.com/foto-gratis/fondo-abstracto-tecnologia-lineas-particulas_53876-104054.jpg')" }}
    >
    ...
    <div className="flex w-full items-center bg-gray-200 justify-center bg-background p-8 md:w-1/2">
      <div className="w-full max-w-md space-y-8 bg-white/90 backdrop-blur-lg shadow-xl p-8 rounded-xl z-10">
        <h1 className="font-bold text-center text-3xl text-blue-500 mb-6">Iniciar sesión</h1>
        {error && (
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="font-semibold text-sm text-gray-600 block" htmlFor="email">
                Correo electrónico
              </label>
              <input
                type="email"
            ...
            <div className="space-y-2">
              <label className="font-semibold text-sm text-gray-600 block" htmlFor="password">
                Contraseña
              </label>
              <input
                type="password"
